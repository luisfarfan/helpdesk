        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="ui-widget">
                        <select id="tecnicos" disabled="" name="tecnico_idusuario" class="form-control">
                ...
                if (!isset($incidencias)) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="ui-widget">
                            <select id="idusuari" disabled="" name="idusuario" class="form-control">
                                <option value=""></option>
                                <?php
                ...
                <?php if (isset($incidencias)) { ?>
                    <div class="form-group">
                        <select id="idestado_incidencia" disabled="" class="form-control" name="idestado_incidencia">
                            <?php
                ...
                if (isset($incidencias)) {
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="solucion" rows="3" disabled="" name="solucion" class="form-control"><?php isset($incidencias) ? print $incidencias[0]['solucion'] : ''; ?></textarea>
                    </div>
                    <?php
                } else {
                    '';
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" disabled="" id="titulo" value="<?php echo $categorias[0]['categoria_nombre'] ?>" class="form-control" id="exampleInputEmail1">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Descripción de la Incidencia</label>
                    <textarea disabled="" class="form-control" rows="3" name="descripcion_incidencia"><?php isset($incidencias) ? print $incidencias[0]['descripcion_incidencia'] : ''; ?></textarea>
                </div>
                <?php
                if (isset($incidencias)) {
